...
final class Medicaments {
    ...
    public HttpResponseMessage medicaments(
        ...
        try {
            ...
            final JSONObject med = new JSONObject(request.getBody().get()).getJSONObject("medicament");
            final Pays pays = Pays.obtenirPays(med.getString("pays"));
            final Long code = med.getLong("code");
            final AbstractEntiteMedicament<? extends Presentation> entiteM = pays == Pays.France
