...
public abstract class AbstractEntite extends TableServiceEntity {
    ...
    protected static <E extends AbstractEntite> Optional<E> obtenirEntite(
        ...
        return Optional.ofNullable(
                obtenirCloudTable(table).execute(tableOperation).getResultAsType());
    }
    ...
    protected static CloudTable obtenirCloudTable(String table)
        ...
        return CloudStorageAccount.parse(System.getenv("AzureWebJobsStorage"))
    ...
    /**
     * Doit renvoyer false s'il y a un problème avec l'entité. Une exception sera alors levée avant
     * la mise à jour serveur, sauf en cas de suppression.
     *
     * @return booléen
     */
