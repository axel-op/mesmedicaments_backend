...
public class EntiteConnexion extends AbstractEntite {
    ...
    public static Optional<EntiteConnexion> obtenirEntite(String id)
        ...
        try {
            TableOperation operation =
                    TableOperation.retrieve(CLE_PARTITION, id, EntiteConnexion.class);
            return Optional.ofNullable(
                    obtenirCloudTable(TABLE).execute(operation).getResultAsType());
    ...
    /**
     * Méthode alternative pour définir les cookies, directement depuis un objet Map. L'objet Map
     * est converti en objet JSON puis en texte.
     *
     * @param cookies
     */
