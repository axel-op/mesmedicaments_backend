...
public class EntiteConnexion extends AbstractEntite {
	...
	public static Optional<EntiteConnexion> obtenirEntite(String id) throws URISyntaxException, InvalidKeyException {
		try {
			TableOperation operation = TableOperation.retrieve(CLE_PARTITION, id, EntiteConnexion.class);
			return Optional.ofNullable(obtenirCloudTable(TABLE).execute(operation).getResultAsType());
	...
	public String getUrlFichierRemboursements() {
		return urlFichierRemboursements;
	}
	...
	public void setTformdata(String tformdata) {
		this.tformdata = tformdata;
	}

	/**
	 * @param cookies Doit pouvoir être désérialisé en JSON
	 * @throws JSONException Si la chaîne de caractères ne représente pas un objet
	 *                       JSON
	 */
	...
	/**
	 * Méthode alternative pour définir les cookies, directement depuis un objet
	 * Map. L'objet Map est converti en objet JSON puis en texte.
	 * 
	 * @param cookies
	 */
	...
	// public void setInscriptionRequise (boolean inscriptionRequise) {
	// this.inscriptionRequise = inscriptionRequise; }
	public void setUrlFichierRemboursements(String url) {
		urlFichierRemboursements = url;
	}
