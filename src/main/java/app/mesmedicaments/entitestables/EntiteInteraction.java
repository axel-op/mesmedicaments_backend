...
public class EntiteInteraction extends AbstractEntite {
    ...
    public static Optional<EntiteInteraction> obtenirEntite(
            EntiteSubstance entite1, EntiteSubstance entite2)
    ...
    public static <E extends AbstractEntiteMedicament<? extends Presentation>>
            Set<EntiteInteraction> obtenirInteractions(Logger logger, Set<E> medicaments) {
        ...
        return Sets.combinations(medicaments, 2)
                ...
                .map(
                        Unchecker.wrap(
                                logger,
                                (List<E> comb) ->
                                        obtenirInteractions(logger, comb.get(0), comb.get(1))))
                .flatMap(Set::stream)
    ...
    public static Set<EntiteInteraction> obtenirInteractions(
        ...
        Function<AbstractEntiteMedicament<? extends Presentation>, Set<String>> subEnCles =
                med ->
                        med.getSubstancesActivesSet().stream()
        ...
        return requetes.stream()
                ...
                .flatMap(
                        Unchecker.wrap(
                                logger,
                                (List<String> cles) ->
                                        obtenirEntite(cles.get(0), cles.get(1))
                                                .map(
                                                        e -> {
    ...
    public EntiteSubstance getEntiteSubstance1()
        ...
        return EntiteSubstance.obtenirEntite(
                        Pays.obtenirPays(getPaysSubstance1()), Long.parseLong(getCodeSubstance1()))
                .get();
    }
    ...
    public EntiteSubstance getEntiteSubstance2()
            throws StorageException, InvalidKeyException, URISyntaxException {
        return EntiteSubstance.obtenirEntite(
                        Pays.obtenirPays(getPaysSubstance2()), Long.parseLong(getCodeSubstance2()))
                .get();
    }
    ...
    @Ignore
    protected <P extends Presentation> void setMedicament1(
            AbstractEntiteMedicament<P> entiteMedicament) {
        entiteMedicament1 = entiteMedicament;
    }

    @Ignore
    protected <P extends Presentation> void setMedicament2(
            AbstractEntiteMedicament<P> entiteMedicament) {
