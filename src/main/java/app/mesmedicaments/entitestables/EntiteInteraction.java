...
public class EntiteInteraction extends AbstractEntite {
        ...
        throws StorageException, URISyntaxException, InvalidKeyException
    {
        ...
        parPartition.values().parallelStream()
            .forEach(set -> {
    ...
    public static Set<EntiteInteraction> obtenirInteractions 
        (Logger logger, AbstractEntiteMedicament<? extends Presentation> medicament1, AbstractEntiteMedicament<? extends Presentation> medicament2)
    {
        Function<AbstractEntiteMedicament<? extends Presentation>, Set<String>> subEnCles = med -> med.getSubstancesActivesSet()
            .stream()
            .map(sub -> med.getPays().code + sub.codeSubstance)
            .collect(Collectors.toSet());
    ...
    private static String[] obtenirClesOrdonnees 
        (EntiteSubstance entiteSubstance1, EntiteSubstance entiteSubstance2)
    {
    ...
    private static String[] obtenirClesOrdonnees (String cle1, String cle2) {
        ...
        return new String[]{
            comparaison == -1 ? cle1 : cle2,
            comparaison == -1 ? cle2 : cle1
        };
    }
    ...
    public EntiteInteraction (EntiteSubstance entite1, EntiteSubstance entite2) {
		super(
            TABLE, 
            obtenirClesOrdonnees(entite1, entite2)[0], 
            obtenirClesOrdonnees(entite1, entite2)[1]
        );
    ...
    public String getPaysSubstance1 () { return paysSubstance1; }
    public String getPaysSubstance2 () { return paysSubstance2; }
    public String getCodeSubstance1 () { return codeSubstance1; }
    public String getCodeSubstance2 () { return codeSubstance2; }


    @Ignore
    public EntiteSubstance getEntiteSubstance1 () 
        throws StorageException, InvalidKeyException, URISyntaxException
    {
        return EntiteSubstance.obtenirEntite(
            Pays.obtenirPays(getPaysSubstance1()),
            Long.parseLong(getCodeSubstance1())
        ).get();
    }

    @Ignore
    public EntiteSubstance getEntiteSubstance2 ()
        throws StorageException, InvalidKeyException, URISyntaxException
    {
        return EntiteSubstance.obtenirEntite(
            Pays.obtenirPays(getPaysSubstance2()),
            Long.parseLong(getCodeSubstance2())
        ).get();
    }
    ...
    public void setPaysSubstance1 (String pays) { this.paysSubstance1 = pays; }
    public void setPaysSubstance2 (String pays) { this.paysSubstance2 = pays; }
    public void setCodeSubstance1 (String code) { this.codeSubstance1 = code; }
    public void setCodeSubstance2 (String code) { this.codeSubstance2 = code; }
